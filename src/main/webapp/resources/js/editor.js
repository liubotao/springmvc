function previewSurvey() {
    edit.saveSurvey().then(function () {
        var e = CA.baseUrlModule + "home/previewSurvey?survey_id=" + survey_init.survey_id + "&from=" + previewFrom;
        $("body").append('<a href="" id="goto_preview" target="_blank"></a>'), $("#goto_preview").attr("href", e), $("#goto_preview").get(0).click()
    })
}
...
function createQuitInfo(e, t) {
    var i = {};
    i.url = window.location.href, i.screenShotUrl = e, i.from = t;
...
$(document).ready(function () {
    $(".survey-nav-tab").click(function () {
        ...
        if ("2" === e && checkSurveyTitle(surveyTitle))if ($(".topic-type-question").length > 0) {
            ...
            surveyTool.createSurveyActionLog(t, "nextStep", "imgClick", survey_init.survey_id), location.href = CA.baseUrlModule + "home/surveyFilter?survey_id=" + survey_init.survey_id
        } else require.async(["home:static/js/survey/widget/operate_popup.js"], function (e) {
            e.show("请完成问卷信息编辑", "确定", null)
        })
    }), survey_init.content && $.each(survey_init.content, function (e, t) {
        $(".question-box-init").remove();
        var i = {};
        i.question_content = t, selectEditedQuestion(i)
    });
    var e = $.Deferred();
    $("body").on("blur", ".edit-title", function () {
        ...
        if (t)if (checkIndexes(t))$(this).parent().parent().find(".question-id").attr("title-quote", "Y"), $(this).parent().parent().children().remove(".title-error-tip"); else {
        ...
        } else $(this).parent().parent().find(".question-id").attr("title-quote", "N"), $(this).parent().parent().children().remove(".title-error-tip")
    }), $(".title-content").trigger("blur"), $(".title-content").focus(function () {
        e = $.Deferred(), $(".survey-title .error-tips").removeClass("error"), $(".survey-title .error-tips").text("")
    }), $(".common-questions ul").hide(), $(".common-questions-title, .select-question-title").click(function () {
        selectQuestionGroup($(this))
    }), $(".common-questions").on("click", ".common_question", function () {
        $(".question-box-init").remove();
        var e = $(this).attr("index");
        selectEditedQuestion(common_question[e]), edit.scrollBox(), setUpdateStatus(), elementInit()
    }), $("#question-box").sortable({
        connectWith: "#question-box", handle: ".drag-area", start: function (e, t) {
            var i = t.item, o = i.find(".question-id").attr("absolute_id");
            logic_condition_relation && logic_condition_relation[o] && !$.isEmptyObject(logic_condition_relation[o]) || logic_show_relation && logic_show_relation[o] && !$.isEmptyObject(logic_show_relation[o]) ? require.async(["home:static/js/survey/widget/sortable_popup.js"], function (e) {
                e.show("该题有关联的逻辑规则，移动题目会导致规则失效，确认移动？", "确定", "取消").then(function () {
                    edit.sortQuestions(), edit.removeLogicCondition(o, i), edit.saveSurvey()
                }, function () {
        ...
        selectQuestion(e), setUpdateStatus()
        ...
        $(".choice .edit-area").css({display: "inline-block"}), $(".edit-img").hide(), $(".edit-area").css({
            background: "#fff",
            border: "none"
        }), $(".title-content").css({border: "1px solid #dbdbdb"}), t != $(".edit-area-active").html() && (t = $(".edit-area-active").html()), selectFinish()
    }), elementInit();
    ...
    $(".edit-area").find("img").each(function () {
        ...
        html2canvas(document.body, {
            allowTaint: !0, taintTest: !1, onrendered: function (t) {
                t.id = "mycanvas", e = t.toDataURL(), popSuggestionSelector(e, "问卷调研")
            }
        })
...
var checkSurveyTitle = function (e) {
    return "" === e ? (showAlert("请正确填写问卷名称"), $("html,body").animate({scrollTop: $(".title-content").offset().top - 50 + "px"}, 500), !1) : !0
}, saveSurvey = function (e, t) {
    if (t) {
        if (createLocked === !1) {
            createLocked = !0, $("#save-button").addClass("save-button-locked");
            var i = "欢迎参加调查！答卷数据仅用于统计分析，请放心填写。题目选项无对错之分，按照实际情况选择即可。感谢您的帮助！", o = 0, n = CA.baseUrlModule + "home/createSurveyProject", r = {
                pro_name: t,
                test_content: i,
                poster: o,
